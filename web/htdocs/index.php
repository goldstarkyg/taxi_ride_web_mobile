		...
		<ul>	<!-- SLIDE  -->
			...
			<li data-index="rs-22" data-transition="fade" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="600"  data-rotate="0"  data-saveperformance="on"  data-title="Slide" data-description="">
				...
				<div class="tp-caption miami_title_60px   tp-resizeme" 
					...
					style="z-index: 5; white-space: nowrap;border-color:rgba(0, 0, 0, 1.00);">OC-Rides
		...
		<section id="service" class="background-dark m-b-10 p-b-10">
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-12 text-center text-light"><h2>Services, which OC-Rides app offers, are a lot!</h2></div>
					...
					<div class="col-md-3">
						...
						<div class="icon-box box-type effect medium center process black-box" data-animation="fadeInUp" data-animation-delay="100">
							...
							<p>For those who want to impress. Be a star and call OC-Rides!</p>
					...
					<div class="col-md-7" data-animation="fadeInUp" data-animation-delay="1000">
						...
						<div class="m-b-40">
							...
							<p>
								...
								Whether you call the Shuttle taxi, Taxi surprise, Zoo Taxi, OC-Rides, Courier Taxi, Promobil Taxi, Drink & Drive Taxi, Limo Taxi and Airport Taxi you will always get upper class taxi servicing.
		...
		<section class="background-grey p-b-40">
			...
			<div class="container">
				<div class="text-center m-b-60" data-animation="fadeInUp" data-animation-delay="100">
					...
					<h1 class="text-medium"><strong>Download</strong> OC-Rides</h1>
			...
			<div class="footer-content">
				...
				<div class="container">
					...
					<div class="row text-center">
						...
						<div class="copyright-text text-center"> © 2017 OC-Rides - Best Taxi Booking App in America. All Rights Reserved.
						...
						<div class="copyright-text text-center"> Created by <a href="#" target="_blank">OC-Rides</a>
