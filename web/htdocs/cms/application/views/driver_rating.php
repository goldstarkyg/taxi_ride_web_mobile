                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div id="content-header" class="clearfix">
                                    <div class="pull-left">
                                        <h1>Driver Rating Details</h1>
                                    </div>
                                    <div class="pull-right">
                                        <ol class="breadcrumb">
                                            <li><a href="#">Home</a></li>
                                            <li class="active"><span>Driver Rating Details</span></li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="main-box clearfix">
                                    <div class="panel">
                                        <div class="panel-body">
                                            <h2 class="pull-left">Driver Rating Details</h2>
                                    ...
                                    <?php
                                    $id=$_GET['driver_id'];
                                    $query = $this->db->query("SELECT dr.driver_rate_id,dr.user_comment,dr.driver_rate,dr.create_date,u.name,u.image FROM `driver_rate` dr JOIN userdetails u on dr.user_id=u.id WHERE dr.driver_id=$id ORDER BY dr.driver_rate_id DESC");
                                    ?>
                                        ...
                                        <div class="table-responsive">
                                            <table id="example" class="table user-list">
                                                ...
                                                foreach ($query->result_array() as $row) {
                                                    ?>
                                                    <tr>
                                                        <td class="text-center"><input type="checkbox" class="deleteRow" value="<?php echo $row['driver_rate_id'];?>"></td>
                                                        <?php
                                                        if($row['image'] !='') {
                                                            ?>
                                                            <td class="text-center"><img class="img-circle"
                                                                                         src="<?php echo base_url() . 'user_image/' . $row['image']; ?>"
                                                        ...
                                                        <td style="width: 250px;"><?php echo $row['user_comment'];?></td>
                                                        <td class="text-center">
                                                            <?php
                                                            $user_avrege=round($row['driver_rate']);
                                                            ?>
                                                        ...
                                                        <td class="text-center">
                                                            <a  href="<?php echo base_url(); ?>admin/edit_driver_rating?id=<?php echo $row['driver_rate_id']; ?>" class="table-link">
                                                        <span class="fa-stack">
                                                            <i class="fa fa-square fa-stack-2x"></i>
                                                            <i class="fa fa-search-plus fa-stack-1x fa-inverse"></i>
                                                        </span>
                                                            </a>
                                                            <a data-target="#uidemo-modals-alerts-delete-user" data-toggle="modal" class="table-link danger" href="javascript:void(0);" onclick="delete_single_user('<?php echo $row['driver_rate_id']; ?>')">
                                                        <span class="fa-stack">
                                                            <i class="fa fa-square fa-stack-2x"></i>
...
<script type="text/javascript" language="javascript" >
    ...
    function delete_user(){
        if( $('.deleteRow:checked').length > 0 ){  // at-least one checkbox checked
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>admin/delete_driver_rating_data",
    ...
    function delete_single_user_action()
    {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>admin/delete_single_driverrating_data",
