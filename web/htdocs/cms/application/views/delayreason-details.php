...
<head>
    ...
    <title>Edit Reason - <?php echo $header_title; ?></title>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div id="content-header" class="clearfix">
                                    <div class="pull-left">
                                        <h1><?php echo $Delay_Reason_lng;?></h1>
                                    </div>
                                    <div class="pull-right">
                                        <ol class="breadcrumb">
                                            <li><a href="#"><?php echo $HOME_lag;?></a></li>
                                            <li class="active"><span><?php echo $Edit_Delay_Reason_lng;?></span></li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="main-box clearfix">
                                    <div class="panel">
                                        <div class="panel-body">
                                            <h2><?php echo $Delay_Reason_lng;?></h2>
                                        </div>
                                    </div>
                                    <?php
                                    $id=$_GET['id'];
                                    ...
                                    <div class="main-box-body clearfix">
                                        <form  enctype="multipart/form-data" method="post" class="form-horizontal" id="formAddUser" name="add_user" role="form">
                                            <div class="form-group">
                                                <label class="col-lg-1 control-label" for="starttime"><?php echo $Reason_Title_lng;?></label>
                                                <div id="inputStartTime" class="col-lg-11">
                                                    <input type="text"  onkeydown="errorValidUser();" placeholder="<?php echo $Enter_Title_lng;?>" name="reason_title" id="reason_title" class="form-control" value="<?php echo $row-> reason_title;?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-1 control-label" for="endtime"><?php echo $Reason_Text_lng;?></label>
                                                <div id="inputEndTime" class="col-lg-11">
                                                    <textarea placeholder="<?php echo $Enter_Reason_lng;?>" name="reason_text" id="reason_text" class="form-control"><?php echo $row->reason_text; ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
