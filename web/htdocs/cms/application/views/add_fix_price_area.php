...
<head>
    ...
    <title>Add Fix Price Area - <?php echo $header_title; ?></title>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div id="content-header" class="clearfix">
                                    <div class="pull-left">
                                        <h1><?php echo $Add_Area_lng;?></h1>
                                    </div>
                                    <div class="pull-right">
                                        <ol class="breadcrumb">
                                            <li><a href="#"><?php echo $home_lng;?></a></li>
                                            <li class="active"><span><?php echo $Add_Area_lng;?></span></li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="main-box clearfix">
                                    <div class="panel" style="margin-bottom:0px;">
                                        <div class="panel-body">
                                            <h2><?php echo $Add_Area_lng;?></h2>
                                        </div>
                                    </div>
                                    <div class="main-box-body clearfix">
                                        <form  enctype="multipart/form-data" method="post" class="form-horizontal" id="formAddUser" name="add_reason" role="form">
                                            <h3><span><?php echo $Add_Area_lng;?></span></h3>
                                            <br />

                                            <div class="form-group">
                                                <label class="col-lg-2 control-label" for="reasontitle"><?php echo $Pick_Area_lng;?></label>
                                                <div id="inputReasonTitle" class="col-lg-10">
                                                    <input type="text" autocomplete="on" onkeyup="javascript:capitalize(this.id, this.value);" onkeydown="errorValidUser();" placeholder="<?php echo $Type_Pick_Area_lng;?>" value="<?=$areaTitle?>" name="areaTitle" id="areaTitle" class="form-control" required>
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="col-lg-2 control-label" for="reasontitle"><?php echo $Area_Range_lng;?></label>
                                                <div id="inputReasonTitle" class="col-lg-10">
                                                    <input type="text" onkeyup="javascript:capitalize(this.id, this.value);" onkeydown="errorValidUser();" placeholder="<?php echo $enter_range_lgn;?>" value="<?=$areaRange?>" name="areaRange" id="areaRange" class="form-control" required>
                                                </div>
                                            </div>
<!--                                            <div class="form-group">-->
...
<!--                                            </div>-->
                                            <div class="form-group">
                                                <label class="col-lg-2 control-label" for="drivername"><?php echo $Area_Price_lng;?></label>
                                                <div id="inputReasonText" class="col-lg-10">
                                                    <input type="text" onkeyup="javascript:capitalize(this.id, this.value);" onkeydown="errorValidUser();" placeholder="<?php echo $enter_price_lng;?>" value="<?=$areaPrice?>" name="areaPrice" id="areaPrice" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-2 control-label" for="drivercartype"><?php echo $Truck_Type_lng;?></label>
                                                ...
                                                <div class="col-lg-offset-2 col-lg-10">
                                                    <?php if(isset($_GET['id'])){ ?>
                                                        <button style="display:block;" class="btn btn-success"  name="update" id="notification-trigger-bouncyflip" type="submit">
                                                            <span id="category_button" class="content"><?php echo $UPDATE_lng;?></span>
                                                        </button>
