...
//echo $id;
$table='driver_rate';
$this->db->select('dr.driver_rate_id,dr.driver_id,dr.user_id,dr.user_comment,dr.driver_rate,dr.create_date,u.name,u.image');
$this->db->from('driver_rate dr');
$this->db->join('userdetails u','dr.user_id=u.id','join');
$this->db->where('dr.driver_rate_id',$id);
$this->db->group_by('dr.driver_rate_id','desc');
...
if(isset($_REQUEST['save']))
{
    ...
    if($data == 1)
    {
        $url=base_url().'admin/driver_rating?driver_id='.$driver_id;
       // redirect("http://$_SERVER[HTTP_HOST]/gagaji/fix_een_bob/admin/driver_rating?driver_id=".$driver_id);
        redirect($url);
    }
}
?>
                                    ...
                                    <div class="main-box-body clearfix">
                                        <form  enctype="multipart/form-data" method="post" class="form-horizontal" role="form">
                                            <div class="form-group">
                                                <label class="col-lg-1 control-label" for="name" style="width: 15%;">user Image</label>
                                                <div id="inputUserName" class="col-lg-11" style="width: 85%;">
                                                    <?php
                                                    if($result[0]['image'] !='') {
                                                        ?>
                                                        <img class="img-circle"
                                                             src="<?php echo base_url() . 'user_image/' . $result[0]['image']; ?>"
                                                             style="min-height:6%;width:6%">
                                                        <?php
                                                    }
                                                    else
                                                    {
                                            ...
                                            <div class="form-group">
                                                <label class="col-lg-1 control-label" for="name" style="width: 15%;">user Name</label>
                                                <div id="inputUserName" class="col-lg-11" style="width: 85%;">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div id="inputUserName" class="col-lg-11" style="width: 85%;">
                                                    <textarea name="comment" class="form-control"><?php echo $result[0]['user_comment']?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div id="inputUserName" class="col-lg-11" style="width: 85%;">
                                                    <?php
                                                    $user_avrege=round($result[0]['driver_rate']);
                                                    ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div id="inputUserName" class="col-lg-11" style="width: 85%;">
						<?php
                                                    $driver_rating=round($result[0]['driver_rate']);
                                                    ?>
                                                    <select name="rating" id="rating" class="form-control">
                                                        <option value="1" <?php echo $driver_rating == 1 ? 'selected="selected"' : ''?>>1</option>
                                                        <option value="2" <?php echo  $driver_rating == 2 ? 'selected="selected"' : ''?>>2</option>
                                                        <option value="3" <?php echo  $driver_rating == 3 ? 'selected="selected"' : ''?>>3</option>
                                                        <option value="4" <?php echo  $driver_rating == 4 ? 'selected="selected"' : ''?>>4</option>
                                                        <option value="5" <?php echo  $driver_rating == 5 ? 'selected="selected"' : ''?>>5</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
