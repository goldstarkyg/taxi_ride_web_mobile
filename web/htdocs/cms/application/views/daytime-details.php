...
<head>
	...
	<title>Edit Day Time - <?php echo $header_title; ?></title>
							...
							<div class="row">
								<div class="col-lg-12">
									<div id="content-header" class="clearfix">
										<div class="pull-left">
											<h1><?php echo $Day_Time_lng?></h1>
										</div>
                    <div class="pull-right">
                    	<ol class="breadcrumb">
												<li><a href="#"><?php echo $HOME_lng;?></a></li>
												<li class="active"><span><?php echo $Day_Time_lng;?></span></li>
											</ol>
                    </div>
									</div>
								</div>
...
//												$query = $this->db->query("update time_detail set WHERE tid=$tid");
                      ...
                      <div class="form-group">
                        <label class="col-lg-1 control-label" for="starttime"><?php echo $Start_Time_lng;?></label>
                        <div id="inputStartTime" class="col-lg-11">
                          <input type="text"  onkeydown="errorValidUser();" placeholder="<?php echo $Enter_start_time_lng;?>" name="starttime" id="starttime" class="form-control" value="<?php echo $row-> day_start_time;?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-lg-1 control-label" for="endtime"><?php echo $End_Time_lng;?></label>
                        <div id="inputEndTime" class="col-lg-11">
                          <input type="text" placeholder="<?php echo $Enter_end_time_lng;?>" name="endtime" id="endtime" class="form-control" value="<?php echo $row->day_end_time; ?>">
                        </div>
                      </div>
                      <div class="form-group">
