...
if(isset($_REQUEST["save"]))
{
    ...
    $payment_date = $server_time;

    $upcar = "UPDATE cashout SET c_driver_id='$driver_id',description='$description',request_date='$request_date',payment_date='$payment_date',request_flag='$request_flag' WHERE cashout_id=$id";
    ...
    if($qr)
    {
        ...
        curl_close($curl);
        //---- Notification End ---------//
        redirect('admin/manage_cashout');
    }
}

$query = $this->db->query("SELECT * FROM  cashout WHERE  cashout_id='$id'");
$row = $query->row('cashout');
?>
...
<head>
    ...
    <title>Cashout Details - <?php echo $header_title; ?></title>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div id="content-header" class="clearfix">
                                    <div class="pull-left">
                                        <h1><?php echo $Cashout_lng;?></h1>
                                    </div>
                                    <div class="pull-right">
                                        <ol class="breadcrumb">
                                            <li><a href="#"><?php echo $HOME_lng;?></a></li>
                                            <li class="active"><span><?php echo $Cashout_lng; ?></span></li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="main-box-body clearfix">
                                        <form  enctype="multipart/form-data" method="post" class="form-horizontal" id="formAddUser" name="add_user" role="form"  onsubmit="return validate()">
                                            <div class="form-group">
                                                <label class="col-lg-2 control-label" for="driver_id"><?php echo $Driver_Id_lng;?></label>
                                                <div id="inputCarType" class="col-lg-10">
                                                    <input type="text"   placeholder="<?php echo $Enter_Driver_Id_lng;?>" name="driver_id" id="driver_id" class="form-control" value="<?php echo $row->c_driver_id ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-2 control-label" for="description"><?php echo $Description_lng;?></label>
                                                <div id="inputCarType" class="col-lg-10">
                                                    <textarea placeholder="<?php echo $Enter_Description_lng;?>" name="description" id="description" class="form-control"><?php echo $row->description ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-2 control-label" for="request_date"><?php echo $RequestDate_lng;?></label>
                                                <div id="inputCarType" class="col-lg-10">
                                                    <input type="text" value="<?php echo $row->request_date ?>"  placeholder="<?php echo $Enter_RequestDate_lng;?>" name="request_date" id="request_date" class="form-control" readonly>
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="col-lg-2 control-label" for="payment_date"><?php echo $PaymentDate_lng;?></label>
                                                <div id="inputCarRate" class="col-lg-10">
                                                    <input type="text" value="<?php echo $row->payment_date ?>" placeholder="<?php echo $Enter_PaymentDate_lng;?>" name="payment_date" id="payment_date" class="form-control" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group">
