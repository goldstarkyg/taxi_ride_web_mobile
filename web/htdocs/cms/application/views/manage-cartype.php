...
<head>
	...
	<title>Manage Car Type - <?php echo $header_title; ?></title>
						...
						<div class="row">
							<div class="col-lg-12">
								<div id="content-header" class="clearfix">
									<div class="pull-left">
										<h1><?php echo $Manage_Car_Type_lng;?></h1>
									</div>
									<div class="pull-right">
										<ol class="breadcrumb">
											<li><a href="#"><?php echo $HOME_lng;?></a></li>
											<li class="active"><span><?php echo $Manage_Car_Type_lng;?></span></li>
										</ol>
									</div>
								</div>
							</div>
								...
								<div class="main-box clearfix">
									<div class="panel">
										<div class="panel-body">
											<h2 class="pull-left"><?php echo $Manage_Car_Type_lng;?></h2>
											<div class="filter-block pull-right">
												...
												<a class="btn btn-primary pull-right" href="javascript:void(0)" onclick="window.location.href='add_car'">
													<i class="fa fa-plus-circle fa-lg"></i> <?php echo $Add_Car_Type_lng;?>
												</a>
												<span>&nbsp;</span>
										...
										<div class="table-responsive">
											<table id="example" class="table user-list">
												...
												<tr>
													...
													<th><a href="javascript:void(0);"><?php echo $CAR_ICON_lng;?></a></th>
													<th><a href="javascript:void(0);"><?php echo $CAR_TYPE_lng;?></a></th>
													<th><a href="javascript:void(0);"><?php echo $CAR_RATE_lng;?></a></th>
													<th><a href="javascript:void(0);"><?php echo $LOADING_CAPACITY_lng;?></a></th>
													<th><a href="javascript:void(1);"><?php echo $Action_lng;?></a></th>
