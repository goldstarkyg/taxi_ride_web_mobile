...
if(isset($_POST['save']))
{
    ...
    $geo = file_get_contents('http://maps.googleapis.com/maps/api/geocode/json?address='.urlencode($areaPincode).'&sensor=false');
    ...
    $sql = "insert into fix_price_area(area_title,pincode,area_range,price,car_type_id,car_type_name,latitude,longitude) values ('$areaTitle','$areaPincode','$areaRange','$areaPrice','$car_type_id','$car_type_name','$latitude','$longitude')";
...
if(isset($_POST['update']))
{
    ...
    $edit_qry = "UPDATE `fix_price_area` SET `pincode`=".$areaPincode.",`area_range`=".$areaRange.",`price`=".$areaPrice.",`car_type_id`=".$car_type_id.",`car_type_name`='".$car_type_name."',`latitude`=".$latitude.",`longitude`=".$longitude." WHERE `area_id`=".$id;
...
<head>
    ...
    <title>Add Fix Price Area - NaqilCom</title>
                                    ...
                                    <div class="main-box-body clearfix">
                                        <form  enctype="multipart/form-data" method="post" class="form-horizontal" id="formAddUser" name="add_reason" role="form">
                                            ...
                                            <div class="form-group">
                                                <label class="col-lg-2 control-label" for="reasontitle">Area Title</label>
                                                <div id="inputReasonTitle" class="col-lg-10">
                                                    <input type="text" onkeyup="javascript:capitalize(this.id, this.value);" onkeydown="errorValidUser();" placeholder="Enter Title" value="<?=$areaTitle?>" name="areaTitle" id="areaTitle" class="form-control" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div id="inputReasonTitle" class="col-lg-10">
                                                    <input type="text" onkeyup="javascript:capitalize(this.id, this.value);" onkeydown="errorValidUser();" placeholder="Enter Range in Miles" value="<?=$areaRange?>" name="areaRange" id="areaRange" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div id="inputReasonText" class="col-lg-10">
                                                    <input type="text" onkeyup="javascript:capitalize(this.id, this.value);" onkeydown="errorValidUser();" placeholder="Enter Price of Area" value="<?=$areaPrice?>" name="areaPrice" id="areaPrice" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
