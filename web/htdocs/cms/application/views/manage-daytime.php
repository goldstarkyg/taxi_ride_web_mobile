			...
			<div class="row">
							...
							<div class="row">
								<div class="col-lg-12">
									<div id="content-header" class="clearfix">
										<div class="pull-left">
											<h1><?php echo $Manage_Day_Time_lng; ?></h1>
										</div>
                    <div class="pull-right">
                    	<ol class="breadcrumb">
												<li><a href="#"><?php echo $HOME_lng;?></a></li>
												<li class="active"><span><?php echo $Manage_Day_Time_lng;?></span></li>
											</ol>
                    </div>
									</div>
								</div>
              ...
              <div class="row">
                      ...
                      <div class="panel-body">
                        	<h2 class="pull-left"><?php echo $Manage_Day_Time_lng;?></h2>
												...
												<table id="example" class="table user-list">
													<thead>
														<tr>
															...
															<th><a href="javascript:void(0);"><?php echo $Start_Time_lng;?></a></th>
															<th><a href="javascript:void(0);"><?php echo $End_Time_lng;?></a></th>
