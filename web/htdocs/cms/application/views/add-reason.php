...
<head>
    ...
    <title>Add Reason - <?php echo $header_title; ?></title>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div id="content-header" class="clearfix">
                                    <div class="pull-left">
                                        <h1><?php echo $Add_Reason_lng;?></h1>
                                    </div>
                                    <div class="pull-right">
                                        <ol class="breadcrumb">
                                            <li><a href="#"><?php echo $Home_lng;?></a></li>
                                            <li class="active"><span><?php echo $Add_Reason_lng;?></span></li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="main-box clearfix">
                                    <div class="panel" style="margin-bottom:0px;">
                                        <div class="panel-body">
                                            <h2><?php echo $Add_Reason_lng;?></h2>
                                        </div>
                                    </div>
                                    <div class="main-box-body clearfix">
                                        <form  enctype="multipart/form-data" method="post" class="form-horizontal" id="formAddUser" name="add_reason" role="form">
                                            <h3><span><?php echo $Add_Reason_lng;?></span></h3>
                                            <br />

                                            <div class="form-group">
                                                <label class="col-lg-2 control-label" for="reasontitle"><?php echo $Reason_Title_lng;?></label>
                                                <div id="inputReasonTitle" class="col-lg-10">
                                                    <input type="text" onkeyup="javascript:capitalize(this.id, this.value);" onkeydown="errorValidUser();" placeholder="<?php echo $Enter_Title_lng;?>" name="reasonTitle" id="reasonTitle" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-2 control-label" for="drivername"><?php echo $Reason_Text_lng; ?></label>
                                                <div id="inputReasonText" class="col-lg-10">
                                                    <textarea onkeyup="javascript:capitalize(this.id, this.value);" onkeydown="errorValidUser();" placeholder="<?php echo $Enter_Reason_lng;?>" name="reasonText" id="reasonText" class="form-control"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
