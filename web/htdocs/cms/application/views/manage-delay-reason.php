...
<head>
    ...
    <title>Manage Delay Reasons - <?php echo $header_title; ?></title>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div id="content-header" class="clearfix">
                                    <div class="pull-left">
                                        <h1><?php echo $Manage_Delay_Reason_lng;?></h1>
                                    </div>
                                    <div class="pull-right">
                                        <ol class="breadcrumb">
                                            <li><a href="#"><?php echo $HOME_lag;?></a></li>
                                            <li class="active"><span><?php echo $Manage_Delay_Reason_lng;?></span></li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button id="confirm-delete-button" onclick="delete_single_reason_action()" data-dismiss="modal" class="btn btn-primary" type="button">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $OK_lng;?>&nbsp;&nbsp;&nbsp;&nbsp;</button>
                                            <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                            ...
                            <div class="modal modal-alert modal-danger fade" id="uidemo-modals-alerts-delete-multipaluser">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body"></div>
                                        <div class="modal-footer">
                                            <button onclick="delete_reason()" data-dismiss="modal" class="btn btn-primary" type="button">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $OK_lng ?>&nbsp;&nbsp;&nbsp;&nbsp;</button>
                                            <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                ...
                                <div class="main-box clearfix">
                                    <div class="panel">
                                        <div class="panel-body">
                                            <h2 class="pull-left"><?php echo $Manage_Delay_Reason_lng;?></h2>
                                        ...
                                        <div class="table-responsive">
                                            <table id="example" class="table user-list">
                                                ...
                                                <tr>
                                                    ...
                                                    <th><a href="javascript:void(0);"><?php echo $Reason_ID_lng;?></a></th>
                                                    <th><a href="javascript:void(0);"><?php echo $Reason_Title_lng;?></a></th>
                                                    <th><a href="javascript:void(0);"><?php  echo $Reason_Text_lng;?></a></th>
