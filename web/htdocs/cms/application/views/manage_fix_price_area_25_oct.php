...
<head>
    ...
    <title>Manage Area - Naqilcom</title>
                            ...
                            <div class="col-lg-12">
                                <div id="content-header" class="clearfix">
                                    ...
                                    <div class="pull-right">
                                        <ol class="breadcrumb">
                                            <li><a href="#">Home</a></li>
                                            <li class="active"><span>Manage Area</span></li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal modal-alert modal-danger fade" id="uidemo-modals-alerts-delete-user">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-title">Are you sure you want to delete the selected area?</div>
                                        <div class="modal-body"></div>
                                        <div class="modal-footer">
                                            <button id="confirm-delete-button" onclick="delete_single_area_action()" data-dismiss="modal" class="btn btn-primary" type="button">&nbsp;&nbsp;&nbsp;&nbsp;OK&nbsp;&nbsp;&nbsp;&nbsp;</button>
                                            <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                            ...
                            <div class="modal modal-alert modal-danger fade" id="uidemo-modals-alerts-delete-multipaluser">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-title">Are you sure you want to delete selected area?</div>
                                        <div class="modal-body"></div>
                                        <div class="modal-footer">
                                            <button onclick="delete_area()" data-dismiss="modal" class="btn btn-primary" type="button">&nbsp;&nbsp;&nbsp;&nbsp;OK&nbsp;&nbsp;&nbsp;&nbsp;</button>
                                            <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                ...
                                <div class="main-box clearfix">
                                    <div class="panel">
                                        <div class="panel-body">
                                            <h2 class="pull-left">Manage Area</h2>
                                        ...
                                        <div class="table-responsive">
                                            <table id="example" class="table user-list">
                                                ...
                                                <tr>
                                                    ...
                                                    <th><a href="javascript:void(0);">Pincode </a></th>
                                                    <th><a href="javascript:void(0);">Range</a></th>
                                                    <th><a href="javascript:void(0);">Price</a></th>
                                                    <th><a href="javascript:void(0);">Car Type</a></th>
                                                    <th class="text-center"><a href="javascript:void(0);">Latitude</a></th>
                                                    <th class="text-center"><a href="javascript:void(0);">Longitude</a></th>
