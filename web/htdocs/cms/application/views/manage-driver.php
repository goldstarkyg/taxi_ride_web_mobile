						...
						<div class="row">
							<div class="col-lg-12">
								<div id="content-header" class="clearfix">
									<div class="pull-left">
										<h1><?php echo $Manage_Driver_lng; ?></h1>
									</div>
									<div class="pull-right">
										<ol class="breadcrumb">
											<li><a href="#"><?php echo $Home_lng; ?></a></li>
											<li class="active"><span><?php echo $Manage_Driver_lng; ?></span></li>
										</ol>
									</div>
								</div>
							</div>
								...
								<div class="main-box clearfix">
									<div class="panel">
										<div class="panel-body">
											<h2 class="pull-left"><?php echo $Manage_Driver_lng; ?></h2>
										...
										<div class="table-responsive">
											<table id="example" class="table user-list">
												...
												<tr>
													...
													<th><a href="javascript:void(0);"><?php echo $IMAGE_lng; ?></a></th>
													<th><a href="javascript:void(0);"><?php echo $NAME_lng; ?></a></th>
													<th><a href="javascript:void(0);"><?php echo $PHONE_NO_lng; ?></a></th>
													<th><a href="javascript:void(0);"><?php echo $ADDRESS_lng; ?></a></th>
													...
													<th><a href="javascript:void(0);"><?php echo $INSPECTION_lng; ?></a></th>
													<th>Rating</th>
													<th><?php echo $Driver_Status_lng; ?></th>
