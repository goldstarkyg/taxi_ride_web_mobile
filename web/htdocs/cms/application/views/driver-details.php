...
if(!empty($query_ac_check)) {
	...
	if(!empty($row_ac->status))
		$ac_check_status = $row_ac->status;
	if(!empty($row_ac->result))
		$ac_check_result = $row_ac->result;
	if(!empty($row_ac->all_text))
...
<!--																				<input type="text" class="form-control" name="inspector" id="inspector" value="--><?php //echo $staff_name ;?><!--" readonly />-->
															...
															<div style="margin-bottom: 30px;">
																<a  id="create_accurate_" class="btn btn-primary pull-right" data-toggle="modal" data-target="#LicenseModal" >
															...
															<div  class="tab-pane fade in active" >
<!--																<P><span class="text-danger">Create Candidate</span></P>-->
																...
																<table id="inspection-record" class="table user-list" style="width:100%;">
																	...
																	<tr>
																		...
																		<td><?php echo $ac_order_id ?></td>
																		<td><?php echo $ac_check_status ?></td>
																		<td><?php echo $ac_order_packagetype ?>+MVR</td>
                                                                ...
                                                                <div class="modal fade" id="LicenseModal"  role="dialog"  >
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
																				<div class="form-group">
																					<label class="col-lg-3 control-label" >Licenses Region</label>
																					<div  class="col-lg-7">
																						<select class="form-control" id="licenses_region" >
																							<option value="AA" selected >Armed Forces Americas</option>
																							<option value="AE" >Armed Forces Europe, Middle East, & Canada</option>
																							<option value="AK" >Alaska</option>
																							<option value="AK" >Alaska</option>US,AL,"Alabama"
																							...
																							<option value="MS" >Mississippi</option>US,MS,""
																							<option value="MT" >Montana</option>
																							<option value="NC" >North Carolina</option>
																							<option value="ND" >North Dakota</option>
																							<option value="NE" >Nebraska</option>US,NE,"Nebraska"
																							...
																							<option value="RN" >Tennessee</option>
																							<option value="TX" >Texas</option>US,TX,"Texas"
																				...
																				<div class="form-group">
																					<label class="col-lg-3 control-label" >Licenses City</label>
																					<div  class="col-lg-7">
																						<input class="form-control" type="text"  id="licenses_city" value="N/A"  />
																					</div>
																				</div>
                                                                            </div>
                                                                            <div class="modal-footer">
																				<button type="button" class="btn btn-secondary" onclick="create_accurate()" data-dismiss="modal">Create</button>
                                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
...
//					d.max_date = filter2;
		...
		if(appoint_id > 0) $('#inspect_appoint').attr('checked', true);
			...
			$('#order_accurate').click(function () {
				check_order_accurate();
			});
		  	//auto check if status is not comploeted.
//			var status = '<?php //echo $ac_check_status ?>//';
//		    if(status == 'PENDING' || status == '') check_order_accurate();

    });

	function  check_order_accurate() {
	...
	function create_accurate() {
		...
		$.ajax({
			...
			data: {
				...
				governmentId_number : 'PAPANDRERM238FL', //ABC12345
				city : 'Irvine',
				region : 'CA',
				country : 'US',
				postalCode: '91234',
//						prevEmployed :'true', //Required for EMP product only in Express workflow, EMP=Employment Verification
//						employments_employer : 'BestBuy', //Required for EMP product only in Express workflow
//						employments_country : 'US',
//						employments_region : 'CA',
//						employments_city : 'Irvine',
//						employments_startDate : '2000-05',
//						employments_endDate : '2004-06',
//						employments_presentlyEmployed : 'true',
//						employments_okToCall : 'true',
//						educations_school : 'UCI', //Required for EDU product only in Express workflow;
//						educations_country: 'US',
//						educations_region : 'CA',
//						educations_city : 'Irvine',
//						educations_degree : 'Master of Something',
//						educations_major : 'Major',
//						educations_startDate : '2000-05',
//						educations_endDate : '2002-06',
//						educations_graduated : 'true',
//						educations_graduationDate : '2004-06',
//						educations_presentlyEnrolled : 'false',
				licenses_category : 'drivers-license', //'professional-license',  Required for MVR and PLV products only in Express workflow
				licenses_type : 'Nursing',
				licenses_number: $('#driver_licenno').val(),
				licenses_issuingAuthority :  'DMV',
				licenses_country : 'US' ,
				licenses_region : $('#licenses_region').val(),//'CA',
				licenses_city: $('#licenses_city').val(), //'N/A',
//						references_name: 'Jane Doe', //Required for REF1 product only in Express workflow;
//						references_relationship : 'co-worker',
//						references_phone : '1234567899',
//						references_email: 'reference@email.com',
//						references_country: 'US',
//						references_region : 'CA',
//						references_city : 'Irvine',
//						references_postalCode : 'ABZ13'
			},
			type: 'post',
			success: function(outdata) {
				output = JSON.parse(outdata);
