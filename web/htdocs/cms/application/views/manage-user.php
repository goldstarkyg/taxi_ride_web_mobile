...
<head>
	...
	<title>Manage User - <?php echo $header_title; ?></title>
						...
						<div class="row">
							<div class="col-lg-12">
								<div id="content-header" class="clearfix">
									<div class="pull-left">
										<h1><?php echo $Manage_User_lng; ?></h1>
									</div>
									<div class="pull-right">
										<ol class="breadcrumb">
											<li><a href="#"><?php echo $home_lng; ?></a></li>
											<li class="active"><span><?php echo $Manage_User_lng; ?></span></li>
										</ol>
									</div>
								</div>
							</div>
								...
								<div class="main-box clearfix">
									<div class="panel">
										<div class="panel-body">
											<h2 class="pull-left"><?php echo $Manage_User_lng; ?></h2>
										...
										<div class="table-responsive">
											<table id="example" class="table user-list">
												...
												<tr>
													...
													<th><a href="javascript:void(0);"><?php echo $User_Image_lng; ?></a></th>
													<!--<th><a href="javascript:void(0);">User Name</a></th>-->
													<th><a href="javascript:void(0);"><?php echo $Email_lng; ?></a></th>
													<!--<th class="text-center"><a href="javascript:void(0);">Gender</a></th>-->
													<th class="text-center"><a href="javascript:void(0);"><?php echo $Mobile_lng; ?></a></th>
<th class="text-center">Rating</th>
										...
										if($permission_name == 'staff' )  {
											if (!in_array(MANAGEUSER_ALLUSER_DELETE, $permission_page)) {
												$permission = false;
											}
										}
										if($permission == true) {
