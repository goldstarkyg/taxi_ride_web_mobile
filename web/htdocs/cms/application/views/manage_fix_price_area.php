...
<head>
    ...
    <title>Manage Area - <?php echo $header_title; ?></title>
                                ...
                                <div id="content-header" class="clearfix">
                                    ...
                                    <div class="pull-right">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="active"><span><?php echo $Manage_Area_lng;?></span></li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal modal-alert modal-danger fade" id="uidemo-modals-alerts-delete-user">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-title"><?php echo $delete_alert_lng;?></div>
                                        <div class="modal-body"></div>
                                        <div class="modal-footer">
                                            <button id="confirm-delete-button" onclick="delete_single_area_action()" data-dismiss="modal" class="btn btn-primary" type="button">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $OK;?>&nbsp;&nbsp;&nbsp;&nbsp;</button>
                                            <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                            ...
                            <div class="modal modal-alert modal-danger fade" id="uidemo-modals-alerts-delete-multipaluser">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body"></div>
                                        <div class="modal-footer">
                                            <button onclick="delete_area()" data-dismiss="modal" class="btn btn-primary" type="button">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $OK;?>&nbsp;&nbsp;&nbsp;&nbsp;</button>
                                            <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                ...
                                <div class="main-box clearfix">
                                    <div class="panel">
                                        <div class="panel-body">
                                            <h2 class="pull-left"><?php echo $Manage_Area_lng;?></h2>
                                            <div class="filter-block pull-right">

                                                <a class="btn btn-primary pull-right" href="javascript:void(0)" onclick="window.location.href='<?php echo base_url(); ?>admin/add_fix_price_area'">
                                                    <i class="fa fa-plus-circle fa-lg"></i><?php echo $Add_lng;?>
                                                </a>
                                               <!-- <span>&nbsp;</span>
                                        ...
                                        <div class="table-responsive">
                                            <table id="example" class="table user-list">
                                                ...
                                                <tr>
                                                    ...
                                                    <th><a href="javascript:void(0);"><?php echo $Title_lng;?> </a></th>
                                                    <th><a href="javascript:void(0);"><?php echo $Range_lng;?></a></th>
                                                    <th><a href="javascript:void(0);"><?php echo $Price_lng;?></a></th>
                                                    <th><a href="javascript:void(0);"><?php echo $Car_Type_lag;?></a></th>
                                                    <th class="text-center"><a href="javascript:void(0);"><?php echo $Latitude_lng;?></a></th>
                                                    <th class="text-center"><a href="javascript:void(0);"><?php echo $Longitude_lng;?></a></th>
...
<script type="text/javascript" language="javascript" >
    $(document).ready(function() {
        ...
        var dataTable = $('#example').DataTable( {
            ...
            "ajax":{
                url : '<?php echo base_url(); ?>admin/get_area_data', // json datasource
    ...
    function delete_area(){
        if( $('.deleteRow:checked').length > 0 ){  // at-least one checkbox checked
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>admin/delete_area_data",
    ...
    function delete_single_area(single_id){
    ...
    function delete_single_area_action()
    {
        var single_id = $('#bookedid').val();
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>admin/delete_single_area_data",
            data: {data_id: single_id},
            success: function (result) {
                var oTable1 = $('#example').DataTable();
                oTable1.ajax.reload(null, false);
