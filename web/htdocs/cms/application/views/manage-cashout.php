...
<head>
	...
	<title>Manage Cashout - <?php echo $header_title; ?></title>
						...
						<div class="row">
							<div class="col-lg-12">
								<div id="content-header" class="clearfix">
									<div class="pull-left">
										<h1><?php echo $Manage_cashout; ?></h1>
									</div>
									<div class="pull-right">
										<ol class="breadcrumb">
											<li><a href="#"><?php echo $Home_lng; ?></a></li>
											<li class="active"><span><?php echo $Manage_cashout; ?></span></li>
										</ol>
									</div>
								</div>
							</div>
								...
								<div class="main-box clearfix">
									<div class="panel">
										<div class="panel-body">
											<h2 class="pull-left"><?php echo $Manage_cashout; ?></h2>
										...
										<div class="table-responsive">
											<table id="example" class="table user-list">
												...
												<tr>
													...
													<th><a href="javascript:void(0);"><?php echo $Request_date_lng; ?></a></th>
													<th><a href="javascript:void(0);"><?php echo $Payment_date_lng; ?></a></th>
													<th class="text-center"><?php echo $Action_lng; ?></th>
													<th class="text-center"><?php echo $Request_flag_lng; ?></th>
												</tr>
												</thead>
											</table>
										</div>
...
<script type="text/javascript" language="javascript" >
	...
	$(document).ready(function() {
		...
		var dataTable = $('#example').DataTable( {
			...
			"ajax":{
				url : '<?php echo base_url(); ?>admin/get_cashout_data', // json datasource
