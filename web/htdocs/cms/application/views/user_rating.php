...
<head>
    ...
    <title>Manage Driver - <?php echo $header_title; ?></title>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div id="content-header" class="clearfix">
                                    <div class="pull-left">
                                        <h1>User Rating Details</h1>
                                    </div>
                                    <div class="pull-right">
                                        <ol class="breadcrumb">
                                            <li><a href="#">Home</a></li>
                                            <li class="active"><span>User Rating Details</span></li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal modal-alert modal-danger fade" id="uidemo-modals-alerts-delete-user">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-title">Are you sure you want to delete the selected rating ?</div>
                                        <div class="modal-body"></div>
                                        <div class="modal-footer">
                                            <button onclick="delete_single_user_action()" data-dismiss="modal" class="btn btn-primary" type="button">&nbsp;&nbsp;&nbsp;&nbsp;OK&nbsp;&nbsp;&nbsp;&nbsp;</button>
                                            <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                            ...
                            <div class="modal modal-alert modal-danger fade" id="uidemo-modals-alerts-delete-multipaluser">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-title">Are you sure you want to delete selected rating ?</div>
                                        <div class="modal-body"></div>
                                        <div class="modal-footer">
                                ...
                                <div class="main-box clearfix">
                                    <div class="panel">
                                        <div class="panel-body">
                                            <h2 class="pull-left">User Rating Details</h2>
                                    ...
                                    <?php
                                    $id=$_GET['user_id'];
                                    $query = $this->db->query("SELECT ur.user_rate_id,ur.driver_comment,ur.user_rate,ur.create_date,d.name,d.image FROM `user_rate` ur JOIN driver_details d on ur.driver_id=d.id WHERE ur.user_id=$id ORDER by ur.user_rate_id DESC");
                                    ?>
                                    <div class="main-box-body clearfix">
                                        <div class="table-responsive">
                                            <table id="example" class="table user-list">
                                                <thead>
                                                <tr>
                                                    <th class="text-center"><input type="checkbox" name="allcheck" id="allcheck"></th>
                                                    <th class="text-center"><a
                                                            href="javascript:void(0);">user Image</a>
                                                    </th>
                                                    <th class="text-center"><a
                                                    ...
                                                    <th class="text-center"><a
                                                            href="javascript:void(0);">Rating</a>
                                                    </th>
                                                    <th class="text-center"><a
                                                ...
                                                foreach ($query->result_array() as $row) {
                                                    ?>
                                                    <tr>
                                                        <td class="text-center"><input type="checkbox" class="deleteRow" value="<?php echo $row['user_rate_id'];?>"></td>
                                                        <td class="text-center"><img class="img-circle" src="<?php echo base_url().'driverimages/'.$row['image']; ?>" height="50" width="50"></i></td>
                                                        <td class="text-center"><?php echo $row['name']; ?></td>
                                                        <td style="width: 250px;"><?php echo $row['driver_comment'];?></td>
                                                        <td class="text-center">
                                                            <?php
                                                            $user_avrege=round($row['user_rate']);
                                                            ?>
                                                        ...
                                                        <td>
                                                        <a  href="<?php echo base_url(); ?>admin/edit_user_rating?id=<?php echo $row['user_rate_id']; ?>" class="table-link">
                                                        <span class="fa-stack">
                                                            <i class="fa fa-square fa-stack-2x"></i>
                                                            <i class="fa fa-search-plus fa-stack-1x fa-inverse"></i>
                                                        </span>
                                                        </a>
                                                        <a data-target="#uidemo-modals-alerts-delete-user" data-toggle="modal" class="table-link danger" href="javascript:void(0);" onclick="delete_single_user('<?php echo $row['user_rate_id']; ?>')">
                                                        <span class="fa-stack">
                                                            <i class="fa fa-square fa-stack-2x"></i>
...
<script type="text/javascript" language="javascript" >
    ...
    function delete_user(){
        if( $('.deleteRow:checked').length > 0 ){  // at-least one checkbox checked
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>admin/delete_rating_data",
    ...
    function delete_single_user_action()
    {
      ...
      //  alert(single_id);
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>admin/delete_single_rating_data",
