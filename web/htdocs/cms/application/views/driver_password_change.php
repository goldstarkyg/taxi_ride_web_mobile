...
<head>
    ...
    <title>Change Password - <?php echo $header_title; ?></title>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div id="content-header" class="clearfix">
                                    <div class="pull-left">
                                        <h1><?php echo $Change_Password_lng; ?></h1>
                                    </div>
                                    <div class="pull-right">
                                        <ol class="breadcrumb">
                                            <li><a href="#"><?php echo $home_lng; ?></a></li>
                                            <li class="active"><span><?php echo $Change_Password_lng; ?></span></li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="main-box clearfix">
                                    <div class="panel">
                                        <div class="panel-body">
                                            <h2><?php echo $Change_Password_lng ?></h2>
                                        </div>
                                    </div>
                                    <?php
                                    $id=$_GET['id'];
                                    if(isset($_REQUEST["save"]))
                                    {
                                        ...
                                        if($password == $confirm_password)
                                        {
                                           // $password=md5($new_password);
                                            $upcar = "UPDATE driver_details SET password='$password' WHERE id=$id";
                                            $qr = mysql_query($upcar);
                                            if ($qr)
                                            {
                                                redirect("admin/view_driver_details?id=$id");
                                            }
                                        }
                                        else
                                        {
                                    ...
                                    <div class="main-box-body clearfix">
                                        <form onsubmit="return validateForm()"  enctype="multipart/form-data" method="post" class="form-horizontal" id="formAddUser" name="change_password" role="form">
                                            ...
                                            <div class="form-group">
                                                <label class="col-lg-1 control-label" for="name" style="width: 15%;"><?php echo $New_Password_lng; ?> *</label>
                                                <div id="inputUserName" class="col-lg-11" style="width: 85%;">
                                                    <input type="password"  placeholder="<?php echo $Enter_New_Password_lng; ?>" name="new_password" id="new_password" class="form-control" <?php echo $permission_changepass_edit ?> />
                                                    <input type="hidden" name="user_id" value="<?php echo $id;?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-1 control-label" for="name" style="width: 15%;"><?php echo $Confirm_Password_lng; ?> *</label>
                                                <div id="inputUserName" class="col-lg-11" style="width: 85%;">
                                                    <input type="password"  placeholder="<?php echo $Enter_Confirm_Password_lng; ?>" name="confirm_password" id="confirm_password" class="form-control" <?php echo $permission_changepass_edit ?> />
                                                </div>
                                            </div>
                                            <?php if ($permission_changepass_edit == '') { ?>
                                            <div class="form-group">
...
<script type="text/javascript">
    function validateForm() {
        ...
        if (np == null || np == "") {
            ...
            {
                alert('Password should be atleast 7 to 15 characters which contain at least one numeric digit.');
                return false;
            }
        }
        else if(cp == null || cp=="")
