                                ...
                                <div class="main-box clearfix">
                                    ...
                                    if(isset($_REQUEST["save"]))
                                    {
                                        ...
                                        if($new_password == $confirm_password)
                                        {
                                            ...
                                            $upcar = "UPDATE userdetails SET password='$password' WHERE id=$id";
                                            $qr = mysql_query($upcar);
                                            if ($qr)
                                            {
                                                redirect("admin/view_userdetails?id=$id");
                                            }
                                        }
                                        else
                                        {
                                        ...
                                        <form onsubmit="return validateForm()"  enctype="multipart/form-data" method="post" class="form-horizontal" id="formAddUser" name="change_password" role="form">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div id="inputUserName" class="col-lg-11" style="width: 85%;">
                                                    <input type="password"  placeholder="<?php echo $Enter_New_Password_lng;?>" name="new_password" id="new_password" class="form-control" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div id="inputUserName" class="col-lg-11" style="width: 85%;">
                                                    <input type="password"  placeholder="<?php echo $Enter_Confirm_Password_lng;?>" name="confirm_password" id="confirm_password" class="form-control">
                                                </div>
                                            </div>
