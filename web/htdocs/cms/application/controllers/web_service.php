	 ...
	 public function profile_edit()
    {
	 ...
	 public function driver_profile_edit()
       ...
       /* $url = $_SERVER['REQUEST_URI'];
        ...
        $driver_ssn= $this->input->post('driver_ssn');
        ...
        else
        {
            ...
            $driver_register = $this->model_web_service->driver_profile_edit($username, $email, $phone,$imgflag,$dlf_flag,$dlb_flag,$vehicle_registration_img_flag,$password, $name, $license_no, $Lieasence_Expiry_Date, $license_plate, $Insurance, $Seating_Capacity, $Car_Model, $Car_Make, $car_no, $car_type, $address, $gender, $dob,$uid,$bank_name,$bank_number,$bank_routing);
        }
...
public function driver_login()
    {
        ...
        if ($result)
        {
            ...
            $query = $this->db->get($table);  //--- Table name = driver_details
...
//http://v1technology.co.uk/demo/naqil/naqilcom/Source/web_service/car_type
    ...
    public function driver_sign_up()
    {
        ...
        openssl_public_encrypt($driver_ssn, $encryptedData, $pubKey);
        //echo $encryptedData;
