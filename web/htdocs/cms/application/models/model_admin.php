...
//		$this->db->join('driver_status','driver_status.driver_id=bookingdetails.id');
	...
	function insert_update_accurate_create($response, $driver_id , $param)
	{
		...
		$data['created'] = date("Y-m-d H:i:s");//$response['created'];
		$data['updated'] = date("Y-m-d H:i:s");//$response['updated'];
		...
		$this->db->where('driver_id',$driver_id);
		$this->db->delete('driver_accurate_create');
	...
	function insert_update_accurate_order($response, $driver_id )
	{
		...
		$data['resource'] = $response['resource'];
		$data['created'] = date("Y-m-d H:i:s"); //$response['created'];
		$data['submitted'] = date("Y-m-d H:i:s");//$response['submitted'];
		$data['updated'] = date("Y-m-d H:i:s"); //$response['updated'];
		...
		$this->db->where('driver_id',$driver_id);
		$this->db->delete('driver_accurate_order');

		$this->db->where('driver_id',$driver_id);
		$this->db->delete('driver_accurate_check');
