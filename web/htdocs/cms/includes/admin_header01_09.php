    ...
    <div class="container">
        <a href="<?php echo base_url();?>admin/dashboard" id="logo" class="navbar-brand">
            <img src="<?php echo base_url();?>upload/okswiss.png" alt="" class="normal-logo logo-white" width="" height="85"/>
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown profile-dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="hidden-xs"><?php echo $data['username'];?></span> <b class="caret"></b>
                        </a>
