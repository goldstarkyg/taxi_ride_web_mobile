...
//		$post_val .= '&employments[].employer='.$employments_employer;
//
//		$employments_country = $_POST['employments_country'];
//		$post_val .= '&employments[].country='.$employments_country;
//
//		$employments_region = $_POST['employments_region'];
//		$post_val .= '&employments[].region='.$employments_region;
//
//		$employments_city = $_POST['employments_city'];
//		$post_val .= '&employments[].city='.$employments_city;
//
//		$employments_startDate = $_POST['employments_startDate'];
//		$post_val .= '&employments[].startDate='.$employments_startDate;
//
//		$employments_endDate =$_POST['employments_endDate'];
//		$post_val .= '&employments[].endDate='.$employments_endDate;
//
//		$employments_presentlyEmployed = $_POST['employments_presentlyEmployed'];
//		$post_val .= '&employments[].presentlyEmployed='.$employments_presentlyEmployed;
//
//		$employments_okToCall = $_POST['employments_okToCall'];
//		$post_val .= '&employments[].okToCall='.$employments_okToCall;
//
//		$educations_school = $_POST['educations_school'];
//		$post_val .= '&educations[].school='.$educations_school;
//
//		$educations_country = $_POST['educations_country'];
//		$post_val .= '&educations[].country='.$educations_country;
//
//		$educations_region = $_POST['educations_region'];
//		$post_val .= '&educations[].region='.$educations_region;
//
//		$educations_city = $_POST['educations_city'];
//		$post_val .= '&educations[].city='.$educations_city;
//
//		$educations_degree = $_POST['educations_degree'];
//		$post_val .= '&educations[].degree='.$educations_degree;
//
//		$educations_major  = $_POST['educations_major'];
//		$post_val .= '&educations[].major='.$educations_major;
//
//		$educations_startDate = $_POST['educations_startDate'];
//		$post_val .= '&educations[].startDate='.$educations_startDate;
//
//		$educations_endDate = $_POST['educations_endDate'];
//		$post_val .= '&educations[].endDate='.$educations_endDate;
//
//		$educations_graduated = $_POST['educations_graduated'];
//		$post_val .= '&educations[].graduated='.$educations_graduated;
//
//		$educations_presentlyEnrolled = $_POST['educations_presentlyEnrolled'];
//		$post_val .= '&educations[].presentlyEnrolled='.$educations_presentlyEnrolled;
//
//		$licenses_category = $_POST['licenses_category'];
//		$post_val .= '&licenses[].category='.$licenses_category;
//
//		$licenses_type = $_POST['licenses_type'];
//		$post_val .= '&licenses[].type='.$licenses_type;
//
//		$licenses_number = $_POST['licenses_number'];
//		$post_val .= '&licenses[].number='.$licenses_number;
//
//		$licenses_issuingAuthority = $_POST['licenses_issuingAuthority'];
//		$post_val .= '&licenses[].issuingAuthority='.$licenses_issuingAuthority;
//
//		$licenses_country = $_POST['licenses_country'];
//		$post_val .= '&licenses[].country='.$licenses_country;
//
//		$licenses_region = $_POST['licenses_region'];
//		$post_val .= '&licenses[].region='.$licenses_region;
//
//		$licenses_city = $_POST['licenses_city'];
//		$post_val .= '&licenses[].city='.$licenses_city;
//
//		$references_name = $_POST['references_name'];
//		$post_val .= '&references[].name='.$references_name;
//
//		$references_relationship = $_POST['references_relationship'];
//		$post_val .= '&references[].relationship='.$references_relationship;
//
//		$references_phone = $_POST['references_phone'];
//		$post_val .= '&references[].phone='.$references_phone;
//
//		$references_email = $_POST['references_email'];
//		$post_val .= '&references[].email='.$references_email;
//
//		$references_country = $_POST['references_country'];
//		$post_val .= '&references[].country='.$references_country;
//
//		$references_region = $_POST['references_region'];
//		$post_val .= '&references[].region='.$references_region;
//
//		$references_city = $_POST['references_city'];
//		$post_val .= '&references[].city='.$references_city;
//
//		$references_postalCode = $_POST['references_postalCode'];
//		$post_val .= '&references[].postalCode='.$references_postalCode;
