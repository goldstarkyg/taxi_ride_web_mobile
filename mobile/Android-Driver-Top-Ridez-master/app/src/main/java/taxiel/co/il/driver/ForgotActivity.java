...
public class ForgotActivity extends AppCompatActivity {
    ...
    //Error Alert
    RelativeLayout rlMainView,layout_retrive_your_password;
    TextView tvTitle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layout_retrive_your_password = (RelativeLayout)findViewById(R.id.layout_retrive_your_password);
        layout_retrive_your_password.setOnClickListener(new View.OnClickListener() {
            @Override
                    ...
                    public void onCompleted(Exception e, JsonObject result) {
                        ...
                        try {
                            ...
                            if(JsonRes.getString("status").equals("success")) {
                                ...
                                Utility.showMKPanelErrorServer(ForgotActivity.this, JsonRes.getString("error code").toString(),rlMainView,tvTitle,regularRoboto,JsonRes.getString("message").toString());
//                                Toast.makeText(ForgotActivity.this, JsonRes.getString("message").toString(), Toast.LENGTH_LONG).show();
                            }
