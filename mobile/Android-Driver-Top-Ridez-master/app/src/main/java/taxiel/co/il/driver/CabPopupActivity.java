...
public class CabPopupActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private static CabPopupActivity inst;

    public static CabPopupActivity instance() {
        return inst;
    }
        ...
        Ion.with(CabPopupActivity.this)
                ...
                .setCallback(new FutureCallback<JsonObject>() {
                    ...
                    public void onCompleted(Exception error, JsonObject result) {
                        ...
                        Common.UpdateSocketDriverStatus(mSocket,userPref,"2");
                        ...
                        if (error == null) {
                            ...
                            try {
                                ...
                                if(resObj.getString("status").equals("success")) {
                                    ...
                                    SharedPreferences.Editor driver_status = userPref.edit();
                                    driver_status.putString("driver_status","busy");
                                    driver_status.commit();
                                ...
                                }else if(resObj.has("status") && resObj.getString("status").equals("false")){
                                        ...
                                        if (error == null) {
                                            try {
                                                ...
                                                if(resObj.getString("status").equals("success")) {
                                                    ...
                                                    SharedPreferences.Editor driver_status = userPref.edit();
                                                    driver_status.putString("driver_status","free"); //busy
                                                    driver_status.commit();
    ...
    public void DriverPopup(){
        ...
        try {
            ...
            customCountdownTimer = Common.AcceptRejectTimer(CabPopupActivity.this,timmer_progress,accpet_time,minutes_value,"cabpopupActivity",userPref,mSocket);
    ...
    public void RejectBookingWithPopup() {

        String DrvRejectUrl = Url.DriverRejectTripUrl + "?booking_id=" + Common.BookingId + "&driver_id=" + userPref.getString("id", "");

        LoaderView loader = new LoaderView(CabPopupActivity.this);
        loader.show();
        Ion.with(CabPopupActivity.this)
                .load(DrvRejectUrl)
                .setTimeout(60*60*1000)
