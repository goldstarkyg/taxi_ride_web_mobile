package taxiel.co.il.driver.Adapter;
...
import taxiel.co.il.driver.utils.CustomMap;
...
//        System.out.println("Payment Status >>>"+allTripFeed.getPaymentStatus());
//        if(position == 0)
//        {
...
//        }
        if(allTripFeed.getDriverFlag().equals("0") && !allTripFeed.getStatus().equals("4")) {
            ...
            System.out.println("Lotlon"+"dialog Lotlon = "+allTripFeed.getPickupLat()+"=="+allTripFeed.getPickupLongs());

            if(allTripFeed.getPickupLat()!=null && allTripFeed.getPickupLongs()!=null && !allTripFeed.getPickupLat().equals("null") && !allTripFeed.getPickupLongs().equals("null"))
            ...
            if (accpet_time > 0 && accpet_time <= 60000) {
                ...
                Log.e("DriverPopup","Driver Status >0>>");

            }
            else
            {

                if(allTripFeed.getDriverFlag().equals("2") || allTripFeed.getStatus().equals("4")){
            ...
            Picasso.with(activity)
               ...
               if(allTripFeed.getPaymentStatus()!=null){
                ...
                if(allTripFeed.getPaymentStatus().equals("1")){
                    holder.rl_payment_type.setVisibility(View.VISIBLE);
                    holder.tv_payment_type.setText(" Pending ");
                    holder.tv_payment_type.setTextColor(ContextCompat.getColor(activity, R.color.booking_truck_type));

                }else if(allTripFeed.getPaymentStatus().equals("2")){
                    holder.rl_payment_type.setVisibility(View.VISIBLE);
                    holder.tv_payment_type.setText(" Complete ");
                    holder.tv_payment_type.setTextColor(ContextCompat.getColor(activity, R.color.detail_color));
    ...
    public class AllTripViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView tv_payment_type,caption_payment_type;
        ...
        public AllTripViewHolder(View view) {
            ...
            //Payment Type
            rl_payment_type=(RelativeLayout)view.findViewById(R.id.rl_payment_type);
            tv_payment_type=(TextView)view.findViewById(R.id.tv_payment_type);
            caption_payment_type=(TextView)view.findViewById(R.id.caption_payment_type);
