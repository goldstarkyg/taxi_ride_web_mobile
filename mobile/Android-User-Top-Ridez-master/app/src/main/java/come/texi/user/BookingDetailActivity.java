...
public class BookingDetailActivity extends AppCompatActivity implements FB_Callback {
    ...
    TextView caption_payment_status,tv_payment_status;
    View v_payment_type;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Payment Type
        layout_payment_status = (RelativeLayout)findViewById(R.id.layout_payment_status);
        caption_payment_status = (TextView)findViewById(R.id.caption_payment_status);
        tv_payment_status = (TextView)findViewById(R.id.tv_payment_status);
        v_payment_type=(View)findViewById(R.id.v_payment_type);
        ...
        if(!allTripFeed.getPaymentStatus().equals("0")){
            layout_payment_status.setVisibility(View.VISIBLE);
            v_payment_type.setVisibility(View.VISIBLE);
            tv_payment_status.setVisibility(View.VISIBLE);
            if(allTripFeed.getPaymentStatus().equals("1")){
                tv_payment_status.setText(allTripFeed.getPaymentType().toLowerCase()+" (Pending) ");
                tv_payment_status.setTextColor(ContextCompat.getColor(this,R.color.booking_truck_type));
            }else{
                tv_payment_status.setText(allTripFeed.getPaymentType().toLowerCase()+" (Complete) ");
                tv_payment_status.setTextColor(ContextCompat.getColor(this,R.color.detail_color));
            }
            System.out.println("Payment Type >1>>"+allTripFeed.getPaymentType().toLowerCase()+allTripFeed.getPaymentStatus());
        }else {
            layout_payment_status.setVisibility(View.GONE);
            v_payment_type.setVisibility(View.GONE);
            tv_payment_status.setVisibility(View.GONE);
            System.out.println("Payment Type >2>>"+allTripFeed.getPaymentType().toLowerCase()+allTripFeed.getPaymentStatus());
        }

        if((allTripFeed.getPaymentType().equals("card") || allTripFeed.getPaymentType().equals("braintree"))&& !allTripFeed.getPaymentStatus().equals("2") && allTripFeed.getStatus().equals("9")){
            runOnUiThread(new Runnable() {
                @Override
                public void run() {

                    Intent ai = new Intent(BookingDetailActivity.this, PaymentTypeActivity.class);
                    ai.putExtra("BookingId",allTripFeed.getBookingId());
                    ai.putExtra("TotalPrice",allTripFeed.getAmount());
                    ai.putExtra("position",Position);
        ...
        if(allTripFeed.getIsUploadReview()!=null && !allTripFeed.getIsUploadReview().equals("") && allTripFeed.getIsUploadReview().equals("1")){
            tv_upload_review.setVisibility(View.GONE);
        }else{
            if(allTripFeed.getStatus().equals("9") && allTripFeed.getIsUploadReview()!=null && !allTripFeed.getIsUploadReview().equals("") && allTripFeed.getIsUploadReview().equals("0")) {
        ...
        tv_upload_review.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MaterialDialog.Builder builder = new MaterialDialog.Builder(BookingDetailActivity.this)
                ...
                dialog.getBuilder().onPositive(new MaterialDialog.SingleButtonCallback() {
                    ...
                    public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                        if(review_rating.getRating()==0){
                            ...
                            Toast.makeText(BookingDetailActivity.this,"Please give rating.", Toast.LENGTH_LONG).show();
                        }else if(edt_reviews.getText().toString().equals("")){
                            Log.e("Okayswiss","Please enter views");
                            Toast.makeText(BookingDetailActivity.this,"Please enter your feed back.", Toast.LENGTH_LONG).show();
                        }else{
                            dialog.cancel();
        ...
        if(allTripFeed.getDriverDetail() != null && allTripFeed.getDriverDetail().equals("null")){
            ...
            Log.e("allTripFeed", "allTripFeed = " + Url.carImageUrl + allTripFeed.getCarIcon());
            Picasso.with(BookingDetailActivity.this)
            ...
            try {
                ...
                img_driver_image.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent driverProfile= new Intent(BookingDetailActivity.this,ReviewProfileActivity.class);
                ...
                rl_view_reviews.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        img_driver_image.performClick();
                    }
                });
                if(drvObj.has("rating_avrage"))
        ...
        layout_back_arrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                resultIntent.putExtra("payment_type", allTripFeed.getPaymentType());
                resultIntent.putExtra("payment_status", allTripFeed.getPaymentStatus());
                resultIntent.putExtra("reviews",allTripFeed.getIsUploadReview());
...
//                .setTimeout(60*60*1000)
                            ...
                            if (error == null) {
                                try {
                                    ...
                                    if (resObj.getString("status").equals("success")) {
                                        ...
                                        Intent logInt = new Intent(BookingDetailActivity.this, LoginOptionActivity.class);
    ...
    public void ShareDialog(){
        ...
        facebook_text.setText(getResources().getString(R.string.facebook_share));

        TextView twitter_text = (TextView)ShareDialog.findViewById(R.id.txt_open_gallery);
        twitter_text.setText(getResources().getString(R.string.twitter_share));
    ...
    public void ShareTwitterLink(){
        String twitterUrl = Url.SocialShareUrl + "?uid=" + userPref.getString("id", "");
    ...
    public void onResume() {
        ...
        IntentFilter filter = new IntentFilter("come.texi.user.BookingDetailActivity");
