...
public class LoginOptionActivity extends AppCompatActivity {
    ...
    ImageView img_logoo,img_background;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_logoo = (ImageView)findViewById(R.id.img_logoo);
        ...
        img_facebook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(getResources().getString(R.string.facebook_app_id).equals("")){
                    Toast.makeText(LoginOptionActivity.this,"Facebook app id is not available.",Toast.LENGTH_LONG).show();
                }else{
                                ...
                                new GraphRequest.GraphJSONObjectCallback() {
                                    ...
                                    public void onCompleted(
                                        ...
                                        if(object!=null){
                                            ...
                                            Toast.makeText(LoginOptionActivity.this,"Something went wrong",Toast.LENGTH_LONG).show();
                                        }
                                    }
                                });
